      ...
      <div className="grid gap-5">
        ...
        {replied ? (
          <section className="soft-card grid grid-cols-[70px_1fr_auto] items-center gap-4 rounded-3xl p-4">
            ...
            <a href={`/child/${childId}/wish-items/${replied.id}/result`} className="rounded-2xl border border-orange-300 px-4 py-2 font-black text-orange-600">
              見る
            </a>
          </section>
        ) : null}
        {consulting ? (
          <section className="rounded-3xl border border-blue-200 bg-blue-50 p-4">
            <div className="mb-2 flex items-center gap-2 text-xl font-black text-blue-700">
              <MessageCircle />
              相談中
            </div>
        ...
        <section className="grid gap-3">
          ...
          {wishItems.length ? (
            ...
            <EmptyState title="まだありません" body="ほしいものを登録してみよう。" />
          )}
        </section>
      </div>
    </ChildShell>
