    ...
    <AppShell showLogout>
      <form action={createChildProfileWithWallet} className="soft-card grid gap-5 rounded-[2rem] p-6">
        ...
        <div>
          ...
          <p className="mt-2 text-sm font-bold text-gray-500">本名ではなくニックネームでOKです。</p>
        </div>
        ...
        <Field label="単位" name="currency_label">
        ...
        <Field label="初期残高" name="initial_balance" type="number" defaultValue={0} required />
